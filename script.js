    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "האתר הנסיוני של מוני משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f08c1d15-0859-494d-9e7d-150647466a1d',
                    name: data.name || '',
                    email: data.email || '',
